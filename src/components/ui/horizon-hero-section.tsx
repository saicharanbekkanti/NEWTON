...
export const HorizonHero = () => {
    ...
    useEffect(() => {
        const initThree = () => {
            ...
            // Get initial locations after mountains are created
    ...
    useEffect(() => {
        ...
        if (titleRef.current) tl.from(titleRef.current, { y: 100, opacity: 0, duration: 1.5, ease: "power4.out" }, "-=0.5");
        if (subtitleRef.current) tl.from(subtitleRef.current, { y: 50, opacity: 0, duration: 1, ease: "power3.out" }, "-=0.8");
